...
/**
 * Thin UI container for the Social Media service. Real data operations delegate to
 * ManageSocialMediaService (resolved via service()), never duplicated here. Placeholder view for now.
 *
