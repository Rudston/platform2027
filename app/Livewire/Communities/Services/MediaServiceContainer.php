...
/**
 * Thin UI container for the Media service. Real data operations delegate to
 * MediaService (resolved via service()), never duplicated here. Placeholder view for now.
 *
 ...
 */
class MediaServiceContainer extends Component
{
    ...
    {
        return view('livewire.communities.services.media-service-container');
    }
}
