...
community.join_instructions, onboarding.new_user_welcome.
...
- Wider placement of x-content-block — currently rendered only at the top
  of the Explore page (explore.welcome_banner); other seeded keys
  (column_browser_hint, community.join_instructions, onboarding.new_user_welcome)
  not yet placed in views
