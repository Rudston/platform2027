    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="flex flex-col">
            ...
            @if ($this->rightColumnCircle)
                ...
                <div class="mt-auto">
                    <livewire:explore.community-card :circle="$this->rightColumnCircle" :from="$this->exploreUrl" :is-member="$this->viewerIsMemberOf($this->rightColumnCircle->id)" :member-count="$this->memberCountFor($this->rightColumnCircle->id)" :key="'location-card-'.$this->rightColumnCircle->id" />
                </div>
            @else
        ...
        <div class="mt-4">
            ...
            @elseif ($this->typeCommunities->isNotEmpty())
                ...
                <x-explore.column-browser
                    ...
                    :member-counts="$this->memberCounts"
                />
